...
export default function Dashboard() {
  ...
  return (
    <>
          ...
          <Link href={`/startup-profile?id=${startup._id}`} key={startup._id}>
            <div className="bg-white rounded-lg shadow p-4 cursor-pointer">
              ...
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-bold text-gray-800">{startup.company_name}</h3>
              </div>
      ...
      {showOnboarding && <Onboarding onComplete={handleOnboardingComplete} onClose={() => setShowOnboarding(false)} />}
    </>
  )
}