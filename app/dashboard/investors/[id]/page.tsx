  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="glass-card rounded-3xl p-8 mb-8 border border-white/50 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full mix-blend-multiply filter blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3"></div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="flex-grow">
            <div className="flex flex-wrap items-center gap-3 mb-2">
              ...
              <span className="px-3 py-1 rounded-full bg-white/60 border border-white/50 text-xs font-bold uppercase tracking-wider text-gray-700 backdrop-blur-sm">
                {investor.type}
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button className="inline-flex items-center px-6 py-2 bg-gray-900 text-white rounded-xl text-sm font-bold hover:bg-black transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3">
              {investor.focus.map((tag) => (
                <div
                  key={tag}
                  className="px-4 py-2 rounded-xl bg-gray-50 border border-gray-100 text-gray-700 font-semibold flex items-center gap-2"
                >
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-6 border border-yellow-100">
            <h4 className="text-sm font-bold text-yellow-800 uppercase tracking-wider mb-4">
              Investment Range
            </h4>
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-3">
              {["Paystack", "Flutterwave", "Andela"].map((company) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-gray-200 flex items-center justify-center text-xs font-bold text-gray-500 group-hover:bg-white group-hover:shadow-md transition-all">
                    {company[0]}
                  </div>
